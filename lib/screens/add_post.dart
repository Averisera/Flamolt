...
class _AddPostScreenState extends State<AddPostScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return _file==null? Scaffold(bottomNavigationBar: BottomNavBar(),
    backgroundColor: Constants.kBlackColor,
    body: 
        Center(child: IconButton(onPressed: (){_selectImage(context);}, icon: const Icon(Icons.upload, color: Constants.kWhiteColor,)),),
    )
    : Scaffold(
      backgroundColor: Constants.kBlackColor,
      appBar: AppBar(
